...
var statsRegExpr = [ [/.*\/rest\/media\/.*/,"GET","/rest/media/*"],
			...
			[/.*\/rest\/user\/.*\/channels/,"GET","/rest/users/*/me/channels"],
			[/.*\/rest\/user\/.*/,"GET","/rest/users/*"],
			[/.*\/rest\/user\/.*\/subscribe\/.*/,"POST","/rest/users/*/me/subscribe/*"],
			//auth ?[/.*\/rest\/user\/auth/,"POST","/rest/user/auth"],
			[/.*\/rest\/user/,"POST","/rest/users"],
			[/.*\/rest\/channel\/.*\/add\/.*/,"POST","/rest/channels/*/members/*"],
			[/.*\/rest\/channel/,"POST","/rest/channels"],
			[/.*\/rest\/channel\/.*\/messages.*/,"GET","/rest/channels/*/messages"],
			[/.*\/rest\/channel\/.*/,"GET","/rest/channels/*"],
			//NA[/.*\/rest\/messages/,"POST","/rest/messages"],
			//NA[/.*\/rest\/messages\/.*/,"GET","/rest/messages/*"]
	]
